...
import { DIANA_LINKEDIN_URL, INSTAGRAM_URL } from '@/content/social';
...
const CONTACT_LINKS = [
  ...
  { id: 'linkedin', label: 'LINKEDIN', sub: 'Diana Vyshnevetska', href: DIANA_LINKEDIN_URL, external: true, icon: 'linkedin' },
